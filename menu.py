...
class Menu:
    ...
    def draw(canvas):
        ...
        canvas.draw_polygon([(100, 50), (300, 50), (300, 100), (100, 100)], 5, '#660099')
        canvas.draw_text('1 player', (160, 80), 18, 'White', 'monospace')
        
        canvas.draw_polygon([(100, 150), (300, 150), (300, 200), (100, 200)], 5, '#660099')
        canvas.draw_text('Options', (170, 180), 18, 'White','monospace')
        
        canvas.draw_polygon([(100, 250), (300, 250), (300, 300), (100, 300)], 5, '#660099')
...
class options:
    ...
    def draw(canvas):
        ...
        canvas.draw_polygon([(100, 20), (120, 20), (120, 40), (100, 40)], 5, 'Green', 'Green')
        canvas.draw_polygon([(140, 20), (160, 20), (160, 40), (140, 40)], 5, 'Red', 'Red')
        canvas.draw_polygon([(180, 20), (200, 20), (200, 40), (180, 40)], 5, 'Blue', 'Blue')
        canvas.draw_polygon([(220, 20), (240, 20), (240, 40), (220, 40)], 5, 'White', 'White')
        canvas.draw_polygon([(260, 20), (280, 20), (280, 40), (260, 40)], 5, 'Fuchsia', 'Fuchsia')   
